...
public class EventServlet extends EventSourceServlet {
    ...
    private final RegistrationListener registrationListener = new RegistrationListener() {
        ...
        public void registered(Registration registration, Registration previousReg,
            ...
            // CONNESSIONE INTERFACCIA GOOGLE
            GoogleInterface.deviceData.addDevice( registration );
            //
        ...
        public void updated(RegistrationUpdate update, Registration updatedRegistration,
            ...
            if( update.getObjectLinks() != null )
                GoogleInterface.deviceData.updateDevice( updatedRegistration );
            //
        ...
        public void unregistered(Registration registration, Collection<Observation> observations, boolean expired,
            ...
            //  CONNESSIONE INTERFACCIA GOOGLE
            GoogleInterface.deviceData.setOffline( registration );
            //
    ...
    private final ObservationListener observationListener = new ObservationListener() {
        ...
        public void onResponse(Observation observation, Registration registration, ObserveResponse response) {
            ...
            GoogleInterface.deviceData.observationController( registration , response );
